...
struct AkPlatformInitSettings
{
	...
	// Web Audio settings
	const char * szAudioWorkletProcessorUrl;    ///< URL of the Audio Worklet processor script. Default: "WwiseAudioWorklet.processor.js"

	bool bVerboseSystemOutput; ///< Print additional debugging information specific to Emscripten to the browser's console output log.
};
